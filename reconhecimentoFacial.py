...
while True:
	...
	if cv2.waitKey(1) & 0xff == ord('k'):
		...
		# Start Movement in CoppelliSim

		iniciar = "s"

		if iniciar == "s":
		# Coordenadas mapeadas para o braço robótico ir para a posição inicial no simulador
			edo.moveJoints(6.3376915497198, 8.867252108834, -33.320176280937, 14.851945821869, 25.074867537546, -13.64536558423) #posição home
			time.sleep(6)
		# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do terminal
			edo.moveJoints(5.8850685738014, -11.013502451727, -42.66819174507, 7.217201348764, 53.740310880254, -4.4078625808677) #posição de segurança acima do terminal
			time.sleep(6)
		# Coordenadas mapeadas para o braço robótico posicionar o target no local de identificação do mesário
		...
		# Coordenadas mapeadas para o braço robótico permanecer com o target no local de identificação do mesário
			edo.moveJoints(0,0,0,0,0,0) #segura
			time.sleep(6)
		# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima da identificação do eleitor
			edo.moveJoints(2.8938828494427, -41.719054997626, 5.6820753516686, 4.9037752957457, 36.254835359724, -3.9519884349044) #posição acima da identificação do eleitor
			time.sleep(6)
		# Coordenadas mapeadas para o braço robótico posicionar o target no local de identificação do eleitor
			edo.moveJoints(2.8834736411476, -55.016859575751, 5.0006683593115, 3.8333070678863, 50.199950625869, -2.4818585179509) #identificação do eleitor
			time.sleep(6)
			print("Identificação do eleitor")
		# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima da identificação do eleitor
			edo.moveJoints(2.8938828494427, -41.719054997626, 5.6820753516686, 4.9037752957457, 36.254835359724, -3.9519884349044) #voltar para identificação do eleitor
			time.sleep(6)
		# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do terminal
			edo.moveJoints(5.8850685738014, -11.013502451727, -42.66819174507, 7.217201348764, 53.740310880254, -4.4078625808677) #posição de segurança acima do terminal
			time.sleep(6)
	...
	# Identificação do eleitor a partir da visão computacional
		if result[0] == 1:
	# Setando o número do título ao eleitor identificado 
			tituloEleitor = "123456789012"
	# Laço para o braço robótico digitar do número do título de eleitor no terminal
		while corrige == "s" and iniciar == "s":
			...
			# Caso tenha o número 0 no título de eleitor
				if tecla == 0:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima da tecla 0
					edo.moveJoints(8.5836216733601, -2.4701105925784, -61.247699646095, 9.5712123858306, 64.12938377768, -4.2326272475219) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 0
			...
			# Caso tenha o número 1 no título de eleitor
				if tecla == 1:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 1
					edo.moveJoints(11.082227815156, -48.818790753044, -31.951925465643, 11.303484963129, 80.913125662882, -1.9154172697034) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 1
			...
			# Caso tenha o número 2 no título de eleitor
				if tecla == 2:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 2
					edo.moveJoints(3.951769868851, -48.511473221529, -33.018309240379, 4.0619408201633, 81.513007517306, -0.68452155861868) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 2
			...
			# Caso tenha o número 3 no título de eleitor
				if tecla == 3:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 3
					edo.moveJoints(-4.4130535246369, -48.53080265688, -32.957192707686, -4.3876998624379, 81.475086307034, 0.55444743606496) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 3
			...
			# Caso tenha o número 4 no título de eleitor
				if tecla == 4:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 4
					...
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 4
			...
			# Caso tenha o número 5 no título de eleitor
				if tecla == 5:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 5
					edo.moveJoints(4.9572556769469, -46.432677826879, -41.6860242028, 5.0496817967955, 88.080466630705, -0.28248296369339) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 5
			...
			# Caso tenha o número 6 no título de eleitor
				if tecla == 6:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 6
					edo.moveJoints(-4.3811428808346, -46.429508619104, -41.70676065712, -4.2964895162615, 88.095575009149, 0.023168001664683) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 6
			...
			# Caso tenha o número 7 no título de eleitor
				if tecla == 7:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 7
					edo.moveJoints(13.862374354539, -45.503949684676, -47.856512721638, 13.978337306268, 93.206906093393, 0.69560012545244) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 7
			...
			# Caso tenha o número 8 no título de eleitor
				if tecla == 8:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 8
					edo.moveJoints(3.68103483053, -43.834760734551, -47.688995502054, 3.7508120430908, 91.621988017249, 0.039410191510974) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 8
			...
			# Caso tenha o número 9 no título de eleitor
				if tecla == 9:
				# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla 9
					edo.moveJoints(-4.674431203795, -44.084636375147, -49.286344522489, -4.6560443345493, 93.457041281178, -0.33439240138548) 
					time.sleep(4)
				# Coordenadas mapeadas para o braço robótico digitar o número 9
			...
			# Código onde o terminal pergunta se o usuário deseja corrigir ou não título de eleitor
				if b == len(tituloEleitor):
					corrige = input("deseja corrigir? s/n  ")
					b = 0

				# Código para caso o usuário digite "s"(sim) para corrigir o título de eleitor e o braço robótico apertar a tecla corrige	
					if corrige == "s":
					# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla corrige
						edo.moveJoints(19.541772272053, -8.3722136581698, -59.693585723107, 20.955471166084, 69.479757822496, -7.6385420582838) 
						time.sleep(6)
					# Coordenadas mapeadas para o braço robótico digitar a tecla corrige
				...
				# Código para caso o usuário digite "n"(não) para não corrigir o título de eleitor e o braço robótico apertar a tecla confirma
					if corrige == "n":
					# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do terminal
						edo.moveJoints(5.8850685738014, -11.013502451727, -42.66819174507, 7.217201348764, 53.740310880254, -4.4078625808677) #segura
						time.sleep(6)
					# Coordenadas mapeadas para o braço robótico ir para a posição de segurança acima do tecla confirma
						...
						time.sleep(6)
					# Coordenadas mapeadas para o braço robótico digitar a tecla confirma
